      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          <div className='flex-shrink-0 flex items-center'>
            <Link to="/" className="text-3xl font-bold text-gray-900 flex-shrink-0 flex items-center">Stylish <span className="text-xs ml-2 text-gray-500">Online Store</span></Link>
          </div>
